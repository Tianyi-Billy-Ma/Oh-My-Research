...
| `/omr:literature-review` | `omr-literature-review` | Search → corpus → summary for a research question. KB-first (Zotero, local PDFs) then MCP fan-out (Exa, Tavily, Brave, HF, GitHub) then web. |
